                    ...
                    <div class="navbar-content">
                        <ul class="navbar-list">
                            ...
                            <li class="navbar-item dropdown">
                                ...
                                <ul class="dropdown-position-list">
                                    ...
                                    <li><a href='offer.html'>fruits</a></li>
                                    <li><a href='profile.html'>dairy farms</a></li>
                                    <li><a href='wallet.html'>seafoods</a></li>
                                    <li><a href='about.html'>diet foods</a></li>
                                    <li><a href='contact.html'>fast foods</a></li>
                                    <li><a href='privacy.html'>drinks</a></li>
                                    <li><a href='coming-soon.html'>meats</a></li>
                                    <li><a href='blank-page.html'>fishes</a></li>
                                    <li><a href='blank-page.html'>dry foods</a></li>
                                </ul>
                        ...
                        <div class="navbar-info-group">
                            ...
                            <div class="navbar-info">
                                ...
                                <div><ul> <li><a class='nav-link' href="{{url('Logout')}}"><i class="icofont-logout"></i>logout</a></li></ul></div>
                            </div>
                        </div>
                    </div>
                </div>
...
<aside class="cart-sidebar">
    ...
    <ul class="cart-list">
        ...
        @foreach ( $user_cart as $usercarT)
            @php
                // Calculate the total price for each item
                $itemTotalPrice = $usercarT->sailing * $usercarT->quantity;
                $totalprice += $itemTotalPrice; // Add the item price to the total cart price
            @endphp
            
            <li class="cart-item">
                <div class="cart-media">
                    <a href="#"><img src="{{$usercarT->image}}" alt="product"></a>
                    <button class="cart-delete" onclick="prodelete({{$usercarT->id}})"><i class="far fa-trash-alt"></i></button>
                </div>
                <div class="cart-info-group">
                    <div class="cart-info">
                        <h6><a href="product-single.html">{{$usercarT->name}}</a></h6>
                        <p>Unit Price - ₹{{$usercarT->sailing}}</p>
                    </div>
                    <div class="cart-action-group">
                        <div class="product-action">
                            <button class="action-minus" title="Quantity Minus" onclick="dddesc({{$usercarT->id}})"><i class="icofont-minus" ></i></button>
                            <input class="action-input" title="Quantity Number" type="text" name="quantity" value="{{$usercarT->quantity}}">
                            <button class="action-plus" title="Quantity Plus"  onclick="Incriment({{$usercarT->id}})"><i class="icofont-plus"></i></button>
                        </div>
