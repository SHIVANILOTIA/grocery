...
<!-- Mirrored from mironcoder-greeny.netlify.app/assets/ltr/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 12 Dec 2024 02:25:33 GMT -->
<meta http-equiv="content-type" content="text/html;charset=UTF-8" />
    <head>
        ...
        <link rel="stylesheet" href="{{url('User/css/index.css')}}">
        <link rel="stylesheet" href="{{url('User/css/main.css')}}">
        <link rel="stylesheet" href="{{url('User/css/product-details.css')}}">
