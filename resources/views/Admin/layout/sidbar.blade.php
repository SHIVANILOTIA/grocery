<div class="page-body-wrapper">
    ...
    <div class="sidebar-wrapper"> 
      <div>
        <div class="logo-wrapper"><a href="index.html"><img class="img-fluid for-light" src="{{url('Admin/assets/images/logo/small-logo.png')}}" alt=""><img class="img-fluid for-dark" src="../assets/images/logo/small-white-logo.png" alt=""></a>
        ...
        <nav class="sidebar-main">
          ...
          <div id="sidebar-menu">
            <ul class="sidebar-links" id="simple-bar">
              <li class="back-btn"><a href="index.html"><img class="img-fluid" src="{{url('Admin/assets/images/logo-icon.png')}}" alt=""></a>
              ...
              <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
               ...
               <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                ...
                <ul class="sidebar-submenu">
                  <li><a href="{{route('Admin.ProductList')}}">Product</a></li>
                  <li><a href="layout-rtl.html">Read</a></li>
