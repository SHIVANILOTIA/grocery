              ...
              <div class="col-xl-3 col-md-6 dash-xl-50">
                <div class="card pb-0 o-hidden earning-card">
                  ...
                  <div class="card-body p-0">
                    <div class="earning-content"><img class="img-fluid" src="{{url('Admin/assets/images/avatar.jpg')}}" alt=""><a href="blog-single.html">
                    ...
                    <div class="table-responsive custom-scrollbar">        
                      <table class="table table-bordernone">                          
                        <tbody> 
                          <tr>
                            <td>
                              <div class="media"><img class="img-fluid me-3 b-r-5" src="{{url('Admin/assets/images/dashboard/rectangle-26.jpg')}}" alt="">
                          ...
                          <tr>
                            <td>
                              <div class="media"> <img class="img-fluid me-3 b-r-5" src="{{url('Admin/assets/images/dashboard/rectangle-27.jpg')}}" alt="">
                                <div class="media-body"><a href="blog-single.html">
                          ...
                          <tr>
                            <td>
                              <div class="media"><img class="img-fluid me-3 b-r-5" src="{{url('Admin/assets/images/dashboard/rectangle-28.jpg')}}" alt="">
                                <div class="media-body"><a href="blog-single.html">
                          ...
                          <tr>
                            <td>
                              <div class="media"><img class="img-fluid me-3 b-r-5" src="{{url('Admin/assets/images/dashboard/rectangle-29.jpg')}}" alt="">
                                <div class="media-body"><a href="blog-single.html">
                      ...
                      <table class="table table-bordernone">
                        ...
                        <tbody> 
                          <tr>
                            <td>
                              <div class="media">
                                <div class="square-box me-2"><img class="img-fluid b-r-5" src="{{url('Admin/assets/images/avtar/boy.png')}}" alt=""></div>
                          ...
                          <tr>
                            <td>
                              <div class="media">
                                <div class="square-box me-2"><img class="img-fluid b-r-5" src="{{url('Admin/assets/images/avtar/girl.png')}}" alt=""></div>
                                <div class="media-body ps-2">
                                  <div class="avatar-details"><a href="product-page.html">
                          ...
                          <tr>
                            <td>
                              <div class="media">
                                <div class="square-box me-2"><img class="img-fluid b-r-5" src="{{url('Admin/assets/images/avtar/man.png')}}" alt=""></div>
                                <div class="media-body ps-2">
                                  <div class="avatar-details"><a href="product-page.html">
                          ...
                          <tr>
                            <td>
                              <div class="media">
                                <div class="square-box me-2"><img class="img-fluid b-r-5" src="{{url('Admin/assets/images/avtar/woman.png')}}" alt=""></div>
                                <div class="media-body ps-2">
                                  <div class="avatar-details"><a href="product-page.html">
                                      <h6>Gary</h6></a><span> UK Desig Team</span></div>
                                </div>
                      ...
                      <table class="table table-bordernone">                          
                        <tbody> 
                          <tr>
                            <td>                          
                              <div class="media">
                                <div class="square-box me-2"><img class="img-fluid b-r-5" src="{{url('Admin/assets/images/avtar/teacher.png')}}" alt=""></div>
                          ...
                          <tr>
                            <td>
                              <div class="media">
                                <div class="square-box me-2"><img class="img-fluid b-r-5" src="{{url('Admin/assets/images/avtar/teenager.png')}}" alt=""></div>
                                <div class="media-body"><a href="user-profile.html">
                          ...
                          <tr>
                            <td>
                              <div class="media">
                                <div class="square-box me-2"><img class="img-fluid b-r-5" src="{{url('Admin/assets/images/avtar/chinese.png')}}" alt=""></div>
                                <div class="media-body image-swipe"><a href="user-profile.html">
                                  ...
                                  <div class="my-gallery" itemscope="">
                                    <div class="row gallery">
                                      <figure class="inner-img ms-3" itemprop="associatedMedia" itemscope=""><a href="{{url('Admin/assets/images/dashboard/img-26.png')}}" itemprop="contentUrl" data-size="600x600"><img class="img-fluid" src="../assets/images/dashboard/img-26.png" itemprop="thumbnail" alt="Image description"></a>
                                        <figcaption itemprop="caption description">Photos 1</figcaption>
                                      </figure>
                                      <figure class="inner-img ms-3" itemprop="associatedMedia" itemscope=""><a href="{{url('Admin/assets/images/dashboard/image-20.jpg')}}" itemprop="contentUrl" data-size="600x600"><img class="img-fluid" src="../assets/images/dashboard/image-20.jpg" itemprop="thumbnail" alt="Image description"></a>
